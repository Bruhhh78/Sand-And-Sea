...
const BasicDetails = ({ prevStep, nextStep, propertyDetails, setPropertyDetails }) => {
  const form = useForm({
    initialValues: {
      title: propertyDetails.title || "", // Initialize to an empty string if undefined
      description: propertyDetails.description || "", // Initialize to an empty string if undefined
      price: propertyDetails.price || 0, // Initialize to 0 if undefined
    },
    validate: {
